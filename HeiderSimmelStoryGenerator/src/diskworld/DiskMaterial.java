 ...
 * - friction
 */
public class DiskMaterial implements Serializable {
	...
	/**
	 * Predefined material: dough, fully inelastic
	 */
	public final static DiskMaterial DOUGH = new DiskMaterial(0.3, 0.02, 0.5, 0.5, Color.YELLOW);
	...
	/**
	 * Predefined material: rubber, fully elastic
	 */
