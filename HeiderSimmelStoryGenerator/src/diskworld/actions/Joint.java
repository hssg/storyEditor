...
public class Joint extends Disk {
	 ...
	 * @param diskType
	 */
	private Joint(DiskComplex diskComplex, Disk parent, double x, double y, double radius, double angle, DiskType diskType) {
	 ...
	 * @param diskType
	 */
	private Joint(DiskComplex diskComplex, Disk parent, double x, double y, double radius, double angle, int zLevel, DiskType diskType) {
		super(diskComplex, x, y, radius, angle, zLevel, diskType);
		this.ranges = new double[JointActionType.ActionType.values().length][];
		this.parent = parent;
		// angle ranges are null by default
	}

	public static Joint createJoint(DiskComplex dc, Disk parent, double x, double y, double radius, double angle, DiskType diskType) {
		 Joint joint = new Joint(dc, parent, x, y, radius, angle, diskType);
		 dc.addNewDisk(joint, parent, true);
		 return joint;
	 }
	
	public static Joint createJoint(DiskComplex dc, Disk parent, double x, double y, double radius, double angle, int zLevel, DiskType diskType) {
		 Joint joint = new Joint(dc, parent, x, y, radius, angle, zLevel, diskType);
		 dc.addNewDisk(joint, parent, true);
		 return joint;
	 }
