...
class MergingDetector {
	...
	public MergingDetector(PhysicsParameters physicsParameters) {
	...
	private boolean canGrip(Collision c1, Collision c2) {
		if ((c1.getObj1() == c2.getObj1()) && (c1.getObj2() == c2.getObj2()))
			return false;
		if ((c1.getObj1() == c2.getObj2()) && (c1.getObj2() == c2.getObj1()))
			return false;
		return true;
	}
	...
	public boolean decideMerge() {
		/*if (collisions.size() > 1) {
			System.out.print("DEBUG: collisions: ");
			for (Collision c : collisions) {
				System.out.print(c.getObj1() + ":" + c.getObj2() + "  ");
			}
			System.out.println();
