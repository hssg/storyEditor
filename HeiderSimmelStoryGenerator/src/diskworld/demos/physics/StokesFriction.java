...
public class StokesFriction extends PhysicsDemo {

	@Override
	public String getTitle() {
		return "Stokes Friction (fluids)";
	}
	...
	public Environment getEnvironment() {
		...
		env.setPhysicsParameters(new DefaultPhysicsParameters(new StokesFrictionModel(env.getFloor(), env.getFloorGrid())));
		Floor floor = env.getFloor();
		FloorCellType fct1 = new FloorCellType(0.6, Color.BLUE);
		FloorCellType fct2 = new FloorCellType(0.4, Color.GREEN);
	...
	public static void main(String[] args) {
		DemoLauncher.runDemo(new StokesFriction());
	}
