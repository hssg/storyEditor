...
public class Epsilons {
	public static final double MAX_RELATIVE_DISK_TIMESTEP_DISPLACEMENT = 0.1; // max. 10% of radius displacement per time step
	...
	public static final double EPSILON_TRANSIENT_EDGE_RELEASE = 1e-9; // threshold for relative change of length that leads to a releaso of a transient edge  
}
