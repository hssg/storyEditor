...
class TestSensor {
	...
	public static void sensor1() {
		...
		//invisibleMaterials.add(DiskMaterial.RUBBER);
		Sensor sensor2 = // ClosestDiskSensor.getPositionAngleSensor(env, 0.25 * Math.PI, 3);
		new ClosestDiskSensor(env, 0.0, 0.75 * Math.PI, 1.5, 5, invisibleMaterials, true, false, false, null, 2);
		...
		env.newRootDisk(9, 4, 0.5, Math.toRadians(0), diskType1);
