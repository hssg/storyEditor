...
public class PolygonDiskSymbol extends AbstractDiskSymbol {
	...
	private static double[][] SHARP_TRIANGLE_POINTS = new double[][] {
			{ 1.0, 0.0 },
	...
	public static PolygonDiskSymbol getSharpTriangleSymbol(double relativeRadius) {
		return new PolygonDiskSymbol(scaled(SHARP_TRIANGLE_POINTS, relativeRadius));
	}
