...
public class VideoCapturer {
	...
	public VideoCapturer(MovieMaker movieMaker, VisualizationSettings settings, double frameRate, int droppedFrames, double startTime) {
	...
	public VideoCapturer(MovieMaker movieMaker, VisualizationSettings settings, double frameRate, int droppedFrames) {
		this(movieMaker, settings, frameRate, droppedFrames, 0.0);
	}
	...
	public void capture(final Environment env) {
		...
		env.addTimeStepListener(new TimeStepListener() {
			...
			public void timeStepDone() {
				if ((frameCount % frameModulo == 0) && (env.getTime() >= startTime)) {
